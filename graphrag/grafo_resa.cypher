...
UNWIND [
  ...
  {nombre: "Residencias_interes_corregido",       desc: "Residencia RESA de interés del usuario."},
...
//      Solo Tabla_Curso: son los únicos valores literales presentes en el .tmdl.
//      El resto de dimensiones son DISTINCT(...) calculados desde el CSV.
// ----------------------------------------------------------------------------
